 ...
 * 2.颜色渐变
 */
public class SomeBeatBalls extends View implements View.OnClickListener {
    //可自定义属性 AttributeSet
    ...
    public SomeBeatBalls(Context context) {
        super(context);
    }
    public SomeBeatBalls(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ballCount = 5;
        paint = new Paint();
...
//                step =1;
    ...
    public SomeBeatBalls(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
